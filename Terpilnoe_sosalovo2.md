...
21. Поясните понятие «стандартный поток операционной системы».  
    - предопределенные потоки ввода-вывода, которые связаны с каждым процессом в операционной системе
...
23. Перечислите основные составлявшие  Windows Console.
...
25. Поясните понятие «асинхронная операция ввода/вывода».  
    - выполнение операций ввода/вывода, которые не блокируют основной поток выполнения программы
...
27. Поясните понятие «файловая система».  
    - метод организации и хранения файлов на компьютере или другом устройстве. Она определяет структуру и правила доступа к файлам и папкам, а также способы их хранения, именования и организации на физическом носителе
...
30. Поясните понятие «порт завершения асинхронных операций ввода/вывода».  
    - механизм в операционной системе Windows, который позволяет эффективно обрабатывать асинхронные операции ввода/вывода
    - представляет собой очередь завершенных операций, в которую помещаются результаты асинхронных операций ввода/вывода. Приложение может зарегистрировать один или несколько портов завершения и ассоциировать их с определенными операциями ввода/вывода. Когда операция завершается, результат помещается в порт завершения, и приложение может извлечь этот результат и продолжить свою работу
...
1.   Две основных компоненты платформы Docker
...
1.   Поясните устройство Docker UFS. 
